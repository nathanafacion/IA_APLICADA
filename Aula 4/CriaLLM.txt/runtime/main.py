...
Uso:
  python main.py rodar --agente ../rota-monitor-agent --entrada "detectar rotas"
  python main.py rodar --agente ../rota-monitor-agent --entrada "detectar rotas" --modo autonomous
  python main.py validar --agente ../rota-monitor-agent
  python main.py rastreamento
  python main.py replay --agente ../rota-monitor-agent
"""
...
def main():
    ...
    parser_rodar.add_argument("--entrada", required=True, help="Entrada do agente")
    parser_rodar.add_argument("--modo", required=False, help="Modo de operacao (task_based, interactive, goal_oriented, autonomous)")
    parser_rodar.add_argument("--evento", required=False, help="Evento trigger para modo autonomous")
